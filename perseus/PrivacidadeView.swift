...
Última Atualização: [Data da Última Atualização]
   ...
   2.1. Consentimento
       ...
       O seu consentimento será obtido de forma específica para cada finalidade acima descrita, evidenciando o compromisso de transparência e boa-fé da (nome empresarial simplificado) para com seus usuários, seguindo as regulações legislativas pertinentes.
