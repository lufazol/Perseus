...
​
    ...
    Dessa forma, o aplicativo VERA CARE, obriga-se ao disposto na presente Política de Privacidade.
​
...
​
   2.1. Consentimento
       É a partir do seu consentimento que tratamos os seus dados pessoais. O consentimento é a manifestação livre, informada e inequívoca pela qual você autoriza o app VERA CARE a tratar seus dados.
       ...
       O seu consentimento será obtido de forma específica para cada finalidade acima descrita, evidenciando o compromisso de transparência e boa-fé do app VERA CARE para com seus usuários, seguindo as regulações legislativas pertinentes.
       Ao utilizar os serviços do app VERA CARE e fornecer seus dados pessoais, você está ciente e consentindo com as disposições desta Política de Privacidade, além de conhecer seus direitos e como exercê-los.
...
​
   3. Quais são os seus direitos?
       O app VERA CARE assegura a seus usuários/clientes seus direitos de titular previstos no artigo 18 da Lei Geral de Proteção de Dados. Dessa forma, você pode, de maneira gratuita e a qualquer tempo:
   ...
   Solicitar a portabilidade de seus dados, através de um relatório de dados cadastrais que o app VERA CARE trata a seu respeito.
...
​
   4. Como você pode exercer seus direitos de titular?
       Para exercer seus direitos de titular, você deve entrar em contato com a equipe de desenvolvimento do app VERA CARE através dos seguintes meios disponíveis:
    glenzolari23@ecps.idserve.net
​
...
​
   5. Como e por quanto tempo seus dados serão armazenados?
       Seus dados pessoais coletados pelo app VERA CASE serão utilizados e armazenados durante o tempo necessário para a prestação do serviço ou para que as finalidades elencadas na presente Política de Privacidade sejam atingidas, considerando os direitos dos titulares dos dados e dos controladores.
       De modo geral, seus dados serão mantidos enquanto a relação contratual entre você e o app VERA CARE perdurar. Findado o período de armazenamento dos dados pessoais, estes serão excluídos de nossas bases de dados ou anonimizados, ressalvadas as hipóteses legalmente previstas no artigo 16 lei geral de proteção de dados, a saber:
...
​
       ...
       O armazenamento de dados coletados pelo app VERA CARE reflete o nosso compromisso com a segurança e privacidade dos seus dados. Empregamos medidas e soluções técnicas de proteção aptas a garantir a confidencialidade, integridade e inviolabilidade dos seus dados. Além disso, também contamos com medidas de segurança apropriadas aos riscos e com controle de acesso às informações armazenadas.
​
...
​
   7. Com quem seus dados podem ser compartilhados?
       Tendo em vista a preservação de sua privacidade, o app VERA CARE não compartilhará seus dados pessoais com nenhum terceiro não autorizado.
   ...
   III – Proteção dos direitos do app VERA CARE em qualquer tipo de conflito, inclusive os de teor judicial.
​
   7.1. Transferência internacional de dados
       ...
       Nesse sentido, o app VERA CARE se compromete a sempre adotar eficientes padrões de segurança cibernética e de proteção de dados, nos melhores esforços de garantir e cumprir as exigências legislativas.
...
​
   8. Alteração desta Política de Privacidade
       A atual versão da Política de Privacidade foi formulada e atualizada pela última vez em: 04/09/2023.
   ...
   9. Responsabilidade
       O app VERA CARE prevê a responsabilidade dos agentes que atuam nos processos de tratamento de dados, em conformidade com os artigos 42 ao 45 da Lei Geral de Proteção de Dados.
       ...
       Caso a Autoridade Nacional de Proteção de Dados exija a adoção de providências em relação ao tratamento de dados realizado pelo app VERA CARE, comprometemo-nos a segui-las.
​
   9.1 Isenção de responsabilidade
       Conforme mencionado no Tópico 6, embora adotemos elevados padrões de segurança a fim de evitar incidentes, não há nenhum aplivativo inteiramente livre de riscos. Nesse sentido, o app VERA CARE não se responsabiliza por:
   ...
   II – Ações maliciosas de terceiros, como ataques de hackers, exceto se comprovada conduta culposa ou deliberada do app VERA CARE.
   ...
   III – Inveracidade das informações inseridas pelo usuário/cliente nos registros necessários para a utilização dos serviços do app VERA CARE; quaisquer consequências decorrentes de informações falsas ou inseridas de má-fé são de inteiramente responsabilidade do usuário/cliente.
​
   11. Encarregado de Proteção de Dados
       O aplicativo VERA CARE disponibiliza os seguintes meios para que você possa entrar em contato conosco para exercer seus direitos de titular: glenzolari23@ecps.idserve.net.
